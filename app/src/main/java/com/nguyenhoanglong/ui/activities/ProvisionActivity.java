...
import com.nguyenhoanglong.AppConstants;
import com.nguyenhoanglong.provisioning.DeviceConnectionEvent;
import com.espressif.wifi_provisioning.R;
import com.nguyenhoanglong.provisioning.ESPConstants;
import com.nguyenhoanglong.provisioning.ESPProvisionManager;
...
public class ProvisionActivity extends AppCompatActivity {
    ...
    private View.OnClickListener okBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            provisionManager.getEspDevice().disconnectDevice();
            finish();
            Intent intent = new Intent(ProvisionActivity.this, NewScreenActivity.class);
...
//        Button newCustomButton = findViewById(R.id.btn_new_custom);
//        newCustomButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(ProvisionActivity.this, NewScreenActivity.class);
//                startActivity(intent);
